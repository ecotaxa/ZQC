...
def checks_multiples(_id, _mode, local_data) : 
    """
    Total living eliminates morphological sub-categories such as "head", "part", "dead", "Insecta", "wing" and "seaweed".
    Ab for Abundance
    Bv for Biovolume

    - Ratio (total multiple/total living)
        The percentage of all multiples categories must be below than 20% of all living categories
        (multiple (other) + multiple (copepoda)) < 20% of (total living) 

    - Ratio multiple (not copepoda)/living (not copepoda)  
        The percentage of multiple (other) must be below than 15% of all living categories except the Copepoda categories
        % multiple (other) < 15% of (living - (Copepoda (with child))

    - Ratio multiple (copepoda)/total copepoda 
        The percentage of multiple (copepoda) must be below than 15% of all Copepoda categories
        % multiple (copepoda) < 15% of total Copepoda (with child)
